            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='exampaper'">
                    <el-form-item class="select" v-if="type!='info'"  label="问卷表" prop="exampaperId">
                        <el-select v-model="ruleForm.exampaperId" filterable placeholder="请选择问卷表" @change="exampaperChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='exampaper' && type!='info'">
                    <el-form-item class="input" v-if="type!='info'"  label="时长(分钟)" prop="exampaperDate">
                        <el-input v-model="exampaperForm.exampaperDate"
                                  placeholder="时长(分钟)" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="时长(分钟)" prop="exampaperDate">
                            <el-input v-model="ruleForm.exampaperDate"
                                      placeholder="时长(分钟)" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='exampaper' && type!='info'">
                    <el-form-item class="input" v-if="type!='info'"  label="问卷状态" prop="exampaperValue">
                        <el-input v-model="exampaperForm.exampaperValue"
                                  placeholder="问卷状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="问卷调查编号" prop="examrecordUuidNumber">
                       <el-input v-model="ruleForm.examrecordUuidNumber"
                                 placeholder="问卷调查编号" clearable  :readonly="ro.examrecordUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="问卷调查编号" prop="examrecordUuidNumber">
                           <el-input v-model="ruleForm.examrecordUuidNumber"
                                     placeholder="问卷调查编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    examrecordUuidNumber: new Date().getTime(),
                    yonghuId: '',
                    exampaperId: '',
                    insertTime: '',
                },
                ...
                rules: {
                   examrecordUuidNumber: [
                              { required: true, message: '问卷调查编号不能为空', trigger: 'blur' },
                          ],
                   yonghuId: [
                              { required: true, message: '问卷调查用户不能为空', trigger: 'blur' },
                          ],
                   exampaperId: [
                              { required: true, message: '所属问卷id（外键）不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
                              { required: true, message: '问卷调查时间不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
