        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='examquestion'">
                    <el-form-item class="select" v-if="type!='info'"  label="题目表" prop="examquestionId">
                        <el-select v-model="ruleForm.examquestionId" filterable placeholder="请选择题目表" @change="examquestionChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='examquestion'">
                    <el-form-item class="input" v-if="type!='info'"  label="题目名称" prop="examquestionName">
                        <el-input v-model="examquestionForm.examquestionName"
                                  placeholder="题目名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="题目名称" prop="examquestionName">
                            <el-input v-model="ruleForm.examquestionName"
                                      placeholder="题目名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="12"  v-if="sessionTable !='examquestion'">
                    <el-form-item class="input" v-if="type!='info'"  label="题目类型" prop="examquestionValue">
                        <el-input v-model="examquestionForm.examquestionValue"
                                  placeholder="题目类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='examquestion'">
                    <el-form-item class="input" v-if="type!='info'"  label="题目排序" prop="examquestionSequence">
                        <el-input v-model="examquestionForm.examquestionSequence"
                                  placeholder="题目排序，值越大排越前面" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="users !='yonghu'">
            ...
            <input id="examquestionId" name="examquestionId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="用户选项" prop="examredetailsMyanswer">
                       <el-input v-model="ruleForm.examredetailsMyanswer"
                                 placeholder="用户选项" clearable  :readonly="ro.examredetailsMyanswer"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="用户选项" prop="examredetailsMyanswer">
                           <el-input v-model="ruleForm.examredetailsMyanswer"
                                     placeholder="用户选项" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    examredetailsUuidNumber: new Date().getTime(),
                    yonghuId: '',
                    examquestionId: '',
                ...
                rules: {
                   ...
                   examquestionId: [
                              { required: true, message: '题目id（外键）不能为空', trigger: 'blur' },
                          ],
                   examredetailsMyanswer: [
                              { required: true, message: '用户选项不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=examredetails_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.examredetailsTypesOptions = data.data.list;
                    }
                });
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='examinationName'){
                          this.ruleForm.examinationName = obj[o];
                          this.ro.examinationName = true;
                          continue;
                      }
                      if(o=='examredetailsTypes'){
                          this.ruleForm.examredetailsTypes = obj[o];
                          this.ro.examredetailsTypes = true;
                          continue;
                      }
                    }
                }
