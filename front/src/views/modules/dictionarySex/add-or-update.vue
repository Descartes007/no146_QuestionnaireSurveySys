    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="性别名称" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="性别名称" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="性别名称" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
                                      placeholder="性别名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        methods: {
            ...
            onSubmit() {
                if((!this.ruleForm.codeIndex)&& !this.$validate.isNumber(this.ruleForm.codeIndex)){
                    this.$message.error('性别编码必须为数字');
                    return
                }
                if((!this.ruleForm.indexName)){
                    this.$message.error('性别名称不能为空');
                    return
                }
