            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex" placeholder="编码" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="类型" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="类型" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=super_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.superTypesOptions = data.data.list;
                    }
                });
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='superTypes'){
                          this.ruleForm.superTypes = obj[o];
                          this.ro.superTypes = true;
                          continue;
                      }
                    }
                }
